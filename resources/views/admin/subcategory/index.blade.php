        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <a class="btn btn-sm btn-warning" data-toggle="modal" href="#subcategory">Add Sub-Category</a>
                    <br>
                    <br>
                        ...
                        <div class="modal-body">
                            <form action="{{route('sub_category.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <input type="text" name="sub_cate_name" class="form-control" placeholder="Sub category" required>
                                </div>

                                <div class="form-group">
                                    <input type="file" name="sub_cate_image" required>
                                </div>
