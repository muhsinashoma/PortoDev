    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <a class="btn btn-sm btn-warning" data-toggle="modal" href="#post_tag">Add New Tag</a>
           <br>
           <br>
      ...
      <!-- Modal -->
      <div class="modal fade" id="post_tag" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{route('post_tag.store')}}" method="POST" enctype="multipart/form-data">
                @csrf
