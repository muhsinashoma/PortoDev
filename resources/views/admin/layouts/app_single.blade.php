...
<!-- Mirrored from www.okler.net/previews/porto/9.0.0/blog-post-sidebar-left.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Jul 2021 10:41:52 GMT -->
<head>
    ...
    <title>Post Left Sidebar | Porto - Responsive HTML5 Template</title>
    ...
    <link rel="stylesheet" href="{{asset('admin/assets/js/porto.js')}}">
                    ...
                    <div class="header-column header-column-border-right flex-grow-0">
                        <div class="header-row pe-4">
                            <div class="header-logo">
                                <a href="index.html">
                                    <img alt="Porto" width="100" height="48" data-sticky-width="82" data-sticky-height="40" src="{{asset('porto/img/logo-default-slim.png')}}">
...
<script src="{{asset('porto/vendor/instafeed/instafeed.min.js')}}"></script>

<!-- Theme Base, Components and Settings -->
<script src="{{asset('port/js/theme.js')}}"></script>

<!-- Theme Initialization Files -->
<script src="{{asset('porto/js/theme.init.js')}}"></script>

<!-- Examples -->
<script src="{{asset('porto/js/examples/examples.instagramFeed.js')}}"></script>

<script defer src="../../../../static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"66b8a7c4ded018e8","version":"2021.6.0","r":1,"token":"03fa3b9eb60b49789931c4694c153f9b","si":10}'></script>
</body>

<!-- Mirrored from www.okler.net/previews/porto/9.0.0/blog-post-sidebar-left.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 08 Jul 2021 10:41:53 GMT -->
</html>
