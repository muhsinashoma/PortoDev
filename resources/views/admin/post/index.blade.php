        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">All Posts(Published)</h3>
                        </div>
                                ...
                                @foreach($all_data as $data )
                                    ...
                                    <tr>
                                        ...
                                        <td style="display: inline-block">
                                            ...
                                            <a class="btn btn-sm btn-warning" alt="Edit"  href="#"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                            <a class="btn btn-sm btn-danger" alt="Delete" href="{{route('post.trash.update', $data->id)}}"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
